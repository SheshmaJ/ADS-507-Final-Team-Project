...
STATEMENT_TITLES = {
    ...
    "data_quality_checks.sql": {
        ...
        2: "NDC Join Coverage Summary",
        3: "Check for Missing Package NDC Values",
        4: "Check for Missing Company Names",
        5: "Check for Missing Shortage Status Values",
        6: "Check for Duplicate Shortage Records",
        7: "Check for Invalid Initial Posting Dates",
        8: "Check for Invalid Update Dates",
        9: "Summary of Shortages by Status",
        10: "Sample of Unmatched Shortages",
        11: "List Recent Shortages Missing NDC Matches",
    },

    "03_analysis_queries.sql": {
        1: "Top manufacturers by current shortage risk",
        2: "Top manufacturers by current shortage risk",
        3: "Branded vs generic drug shortages",
        4: "Products with multiple affected packages",
        5: "Shortages by product type",
        6: "Shortages by package type",
        7: "Shortages by administration route",
        8: "Overall join coverage summary",
        9: "Marketing category impact analysis",
        10: "Longest active shortages with with full product and manufacturer details.",
        11: "Manufacturer shortage rate vs their product portfolio size",
        12: "Confirms that all analysis queries ran successfully",
        13: "Final Validation: All Analysis Queries Executed Successfully",
    },
}
